...
//         
//         columnIdCategoria.setMaxWidth(0);
//         columnIdCategoria.setMinWidth(0);
//         
//         columnIdMarca.setMaxWidth(0);
//         columnIdMarca.setMinWidth(0);
//         
     }
    /**
    ...
    private void SeleccionarIdCategoria(String categoriaSeleccionada){
        //DatosCategoria datosCat = new DatosCategoria();
        //Categoria cat = new Categoria(2, "test");
        ...
        //Categoria cat = new Categoria(ABORT, title)
        //cboidCat.setSelectedItem(ABORT);
    }
